package com.springbootconcepts.modifyrequest.interceptor;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.web.servlet.HandlerInterceptor;

import com.springbootconcepts.modifyrequest.requestwrapper.EscapeHtmlRequestWrapper;
...
public class EscapeHtmlRequestInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        return HandlerInterceptor.super.preHandle(escapeHtmlRequestWrapper, response, handler);
